...
централизованная и децентрализованная. Выбор
стратегии зависит от числа участников и места проведения
...
4) Возьмите USB диск, на котором вы будете хранить ключи,
...
5e) Выберите парольную фразу. Парольная фраза является гарантом
    ...
    вы не сможете дешифровать свой закрытый ключ.
...
9) Напишите электронное письмо координатору, уведомите его о том, что вы
   ...
   команды - он содержит всю необходимую информацию, если ваш
   ключ уже хранится на сервере ключей. Разумеется, ваше письмо
...
Сравните выведенный отпечаток с отпечатком на
списке участников. Внимание! Не полагайтесь на отпечаток, который
показывает сервер ключей - возможно, для загрузки вам будет
предложен один ключ, а отпечаток показан от другого.
...
Возможно, вам будет необходимо удалить версию GnuPG, поставляющуюся
с дистрибутивом, если вы собираете более новую версию
из исходных текстов.
