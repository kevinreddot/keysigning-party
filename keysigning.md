...
другие люди, имеет смысл установить gpg как SUID root - это позволит
gpg установить защиту сегментов памяти, где хранится секретная
...
5f) Пошевелите мышкой, нажмите несколько случайных клавиш, запустите
    ...
    создания ключей, gpg требуется некоторое количество случайных
    данных. Для сбора данных gpg читает из /dev/random; энтропия данных
